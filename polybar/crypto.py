...
with open('/home/mclellac/.config/polybar/crypto-config', 'r', encoding='utf-8') as f:
	config.read_file(f)
...
for currency in currencies:
	...
	json = requests.get(f'https://api.coinmarketcap.com/v1/ticker/{currency}', params=params).json()[0]
