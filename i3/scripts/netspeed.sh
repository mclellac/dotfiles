...
ens33="`(find /sys/devices -name ens33)`/statistics"
echo $ens33
#ens33="/sys/devices/pci0000:00/0000:00:19.0/net/ens33/statistics"
#wlan0="/sys/devices/pci0000:00/0000:00:1c.1/0000:03:00.0/net/wlan0/statistics"
read ens33_rx < "${ens33}/rx_bytes"
read ens33_tx < "${ens33}/tx_bytes"


# get time and sum of rx/tx for combined display
time=$(date +%s)
rx=$(( $ens33_rx + $wlan0_rx ))
tx=$(( $ens33_tx + $wlan0_tx ))
